...
// MPU6500 IIC地址定义（根据数据手册第30页）
#define MPU6500_I2C_ADDRESS_AD0_LOW 0x68  // AD0引脚接地
#define MPU6500_I2C_ADDRESS_AD0_HIGH 0x69 // AD0引脚接VDDIO

// 默认使用AD0接地地址
#define MPU6500_I2C_ADDR MPU6500_I2C_ADDRESS_AD0_LOW

// MPU6500寄存器地址定义（与SPI版本相同）
...
#define MPU6500_ACCEL_CONFIG2_REG 0x1D
#define MPU6500_LP_ACCEL_ODR 0x1E
#define MPU6500_WOM_THR 0x1F

#define MPU6500_ACCEL_XOUT_H_REG 0x3B
#define MPU6500_ACCEL_XOUT_L_REG 0x3C
#define MPU6500_ACCEL_YOUT_H_REG 0x3D
#define MPU6500_ACCEL_YOUT_L_REG 0x3E
#define MPU6500_ACCEL_ZOUT_H_REG 0x3F
#define MPU6500_ACCEL_ZOUT_L_REG 0x40

#define MPU6500_TEMP_OUT_H_REG 0x41
#define MPU6500_TEMP_OUT_L_REG 0x42

#define MPU6500_GYRO_XOUT_H_REG 0x43
#define MPU6500_GYRO_XOUT_L_REG 0x44
#define MPU6500_GYRO_YOUT_H_REG 0x45
#define MPU6500_GYRO_YOUT_L_REG 0x46
#define MPU6500_GYRO_ZOUT_H_REG 0x47
#define MPU6500_GYRO_ZOUT_L_REG 0x48
...
#define MPU6500_USER_CTRL_REG 0x6A
#define MPU6500_PWR_MGMT_1_REG 0x6B
#define MPU6500_PWR_MGMT_2_REG 0x6C
...
#define MPU6500_INT_ENABLE_REG 0x38
#define MPU6500_INT_PIN_CFG 0x37
#define MPU6500_INT_STATUS_REG 0x3A
...
#define DLPF_BW_3600HZ 0x07

// 用户控制寄存器位定义（IIC模式下）
#define USER_CTRL_FIFO_EN 0x40
#define USER_CTRL_I2C_MST_EN 0x20
#define USER_CTRL_I2C_IF_DIS 0x10 // 注意：IIC模式下应设为0
...
#define PWR1_CYCLE 0x20
#define PWR1_GYRO_STANDBY 0x10
#define PWR1_PD_PTAT 0x08
#define PWR1_CLKSEL_INTERNAL 0x00
#define PWR1_CLKSEL_GYRO_X 0x01
#define PWR1_CLKSEL_GYRO_Y 0x02
#define PWR1_CLKSEL_GYRO_Z 0x03
#define PWR1_CLKSEL_EXT_32KHZ 0x04
#define PWR1_CLKSEL_EXT_19MHZ 0x05
#define PWR1_CLKSEL_STOP 0x07

// 电源管理寄存器2位定义
#define PWR2_DISABLE_XA 0x20
#define PWR2_DISABLE_YA 0x10
#define PWR2_DISABLE_ZA 0x08
#define PWR2_DISABLE_XG 0x04
#define PWR2_DISABLE_YG 0x02
#define PWR2_DISABLE_ZG 0x01
#define PWR2_DISABLE_ALL_ACCEL                                                 \
  (PWR2_DISABLE_XA | PWR2_DISABLE_YA | PWR2_DISABLE_ZA)
#define PWR2_DISABLE_ALL_GYRO                                                  \
  (PWR2_DISABLE_XG | PWR2_DISABLE_YG | PWR2_DISABLE_ZG)
...
#define INT_ENABLE_DMP 0x02
#define INT_ENABLE_FIFO_OFLOW 0x10
